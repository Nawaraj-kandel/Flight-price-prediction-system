        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-3 border ${
                errors.transit_count ? "border-red-500" : "border-gray-300"
              } rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none`}
          ...
          <ul>
            {predictions.map((prediction, index) => (
              <li key={index} className="p-4 border-b last:border-b-0">
                <p className="text-lg font-semibold text-gray-700">{prediction.flightName}</p>
                <p className="text-green-600 font-medium">{prediction.price}</p>
              </li>
            ))}
          </ul>
        </div>
